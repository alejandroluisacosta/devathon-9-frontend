...
export const Rules = ({ closeModal }) => {
    return (
        <div className="rules modal-fade-in">
            ...
            <h1 className='rules__title'>Expelliarmicus™ es el juego donde los verdaderos magos resuelven sus diferencias. ¿Te atreves?</h1>
            ...
            <button className="rules__close-button" onClick={closeModal}>Cerrar</button>
        </div>
    )
}